...
export function listSampleFileConfig(params) {
  return request({
    url: '/sample/config/config/list',
    method: 'get',
    params
  })
}
...
export function categorySampleComputerDict() {
  return request({
    url: '/sample/config/category/computer',
    method: 'get'
  })
}
...
export function authSampleFileConfig(data) {
  return request({
    url: '/sample/config/config/auth',
    method: 'put',
    data
  })
}

export function addSampleFileConfig(data) {
  return request({
    url: '/sample/config/config',
    method: 'post',
    data: data
  })
}

export function editSampleFileConfig(data) {
  return request({
    url: '/sample/config/config',
    method: 'put',
    data: data
...
export function computerSampleDictList(data) {
  return request({
    url: '/sample/config/config/dirt',
    method: 'get',
    params: data
  })
}
...
// 撤回
export function fileSampleCancel(data) {
  return request({
    url: '/sample/config/config/cancel',
    method: 'put',
    data
  })
}
...
// 批量重审
export function resetSampleFileConfig(data) {
  return request({
    url: '/sample/config/config/reset',
    method: 'put',
    data
  })
}
...
// 获取SN信息
export function fileSampleConfigSn(params) {
  return request({
    url: '/sample/config/config/sn',
    method: 'get',
    params
  })
}
...
// 批量同步
export function resetSampleBatchSync(data) {
  return request({
    url: '/sample/config/sync/config',
    method: 'put',
    data
  })
}
...
// 批量同步文件
export function sampleFileBatchSyncConfig(data) {
  return request({
    url: '/sample/config/batch/sync/config',
    method: 'put',
    data
  })
}