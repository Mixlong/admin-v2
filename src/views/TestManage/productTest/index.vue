  ...
  <div class="app-container font12">
    ...
    <el-table v-loading="loading" :data="list" :height="tableHeight()" border>
      ...
      <el-table-column
        ...
        width="200"
      />
      <el-table-column label="客户" prop="desc" align="center" />
      <el-table-column label="仪表型号" prop="desc" align="center" />
      ...
      <el-table-column label="操作" align="center" width="160">
        <template slot-scope="scope">
          ...
          />
          <Tooltip icon="el-icon-delete" content="修复中" />
          <Tooltip icon="el-icon-delete" content="复测中" />
          <Tooltip icon="el-icon-delete" content="测试完毕" />
        </template>
      </el-table-column>
    </el-table>
    <pagination
