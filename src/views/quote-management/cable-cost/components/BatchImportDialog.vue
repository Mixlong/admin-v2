<template>
  <el-dialog title="批量导入线缆成本" :visible.sync="dialogVisible" width="900px" :close-on-click-modal="false"
...
<script>
import { importCableCost } from '@/api/quote-management/cableCost'
  ...
  methods: {
    ...
    async downloadTemplate() {
      try {
        ...
        link.href = 'http://file.riding-evolved.com/20250728/1753704413/线缆成本导入模板.xlsx'
    ...
    async handleImport() {
      ...
      try {
        ...
        const response = await importCableCost(formData)
