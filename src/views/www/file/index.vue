<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="仪表" prop="type">
        <el-select
...
<script>
import { fileList, fileAuth } from "@/api/home/file";
import CompUpdate from "./components/update";
import { computerDir, computerList } from "@/api/home/computer";
...
export default {
  ...
  mounted() {
    computerList({ p: 1, l: 1000 }).then((res) => {
  ...
  methods: {
    ...
    typeName(row) {
      let data = this.typeOptions.filter((item) => item.id == row.type);
