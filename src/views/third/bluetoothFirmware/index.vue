<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="firmwareList" :height="tableHeight()" border>
      ...
      <el-table-column label="版本号" prop="versionNumber" width="120" align="center" show-overflow-tooltip />
      <el-table-column label="芯片平台" prop="chipPlatform" width="150" align="center" show-overflow-tooltip />
      <el-table-column label="客户" prop="customer" width="120" align="center" show-overflow-tooltip />
      <el-table-column label="项目" prop="project" width="120" align="center" show-overflow-tooltip />
