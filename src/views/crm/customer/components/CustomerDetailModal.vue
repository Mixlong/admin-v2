    ...
    <div v-if="customer" class="customer-detail-container">
      ...
      <div class="customer-header">
        <div class="customer-info">
          <el-avatar :size="60" class="bg-blue-600" style="margin-right:10px">
          ...
          <div class="ml-4">
            <div class="customer-name">
              ...
              <el-tag :type="getStatusType(customer.customerStatus)" class="ml-2">
      ...
      <!-- 标签页内容 -->
      <el-tabs v-model="activeTab" tab-position="top" class="customer-tabs">
        <!-- 基础信息 -->
            ...
            <div class="info-section">
              ...
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <div class="info-value">{{ customer.customerBrand || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">所属国家</div>
                  <div class="info-value">{{ getDictLabel('country_origin', customer.country) || customer.country || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">客户状态</div>
                  <div class="info-value">
                    <el-tag :type="getStatusType(customer.customerStatus)" size="small">
                      {{ getStatusText(customer.customerStatus) }}
                  </el-tag>
                  </div>
                </div>
                 <div class="info-item">
                   ...
                   <div class="info-value">
                     <el-tag :type="getLevelType(customer.customerLevel)" size="small" v-if="customer.customerLevel">
                       {{ getDictLabel('customer_type_enum', customer.customerLevel) || customer.customerLevel }}
                     </el-tag>
                     <span v-else>--</span>
                   </div>
                 </div>
            ...
            <div class="info-section">
              ...
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <div class="info-value">{{ customer.instrumentSupplier || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">组装工厂</div>
                  <div class="info-value">{{ customer.assemblyFactory || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">年出货量</div>
                  <div class="info-value">{{ customer.annualShipments || '--' }}</div>
                </div>
                 <div class="info-item">
                   ...
                   <div class="info-value">
                     <template v-if="customer.productIntent">
                       <el-tag 
                         v-for="(intent, index) in getProductIntentArray(customer.productIntent)" 
                         :key="index"
                         size="mini"
                         type="info"
                         class="mr-1"
                       >
                         {{ getDictLabel('product_intention', intent) || intent }}
                       </el-tag>
                     </template>
                     <span v-else>--</span>
                   </div>
                ...
                <div class="info-item info-item--span3">
                  ...
                  <div class="info-value text-content">{{ customer.backgroundCheck || '--' }}</div>
                </div>
              </div>
            </div>
            ...
            <div class="info-section">
              ...
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <div class="info-value">
                  <el-tag :type="getTaxTypeColor(customer.taxType)" size="small">
                      {{ getDictLabel('tax_type', customer.taxType) || customer.taxType || '--' }}
                  </el-tag>
                  </div>
                </div>
                <div class="info-item">
                  <div class="info-label">增值税税率(%)</div>
                  <div class="info-value">{{ customer.vatRate !== undefined && customer.vatRate !== null ? `${customer.vatRate}%` : '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">发票抬头</div>
                  <div class="info-value">{{ customer.invoiceTitle || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">发票税号</div>
                  <div class="info-value">{{ customer.invoiceTaxNo || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">开户银行</div>
                  <div class="info-value">
                     <el-tag :type="getBankColor(customer.bankName)" size="small">
                       {{ getDictLabel('bank_account', customer.bankName) || customer.bankName || '--' }}
                  </el-tag>
                  </div>
                </div>
                <div class="info-item">
                  <div class="info-label">银行账户</div>
                  <div class="info-value">{{ customer.bankAccount || '--' }}</div>
                </div>
                <div class="info-item">
            ...
            <div class="info-section">
              ...
              <div class="info-grid">
                <div class="info-item">
                  ...
                  <div class="user-info">
                    <el-avatar :size="20" class="bg-blue-600">
                        {{ customer.salesLeader && customer.salesLeader.charAt(0) }}
                    </el-avatar>
                      <span class="user-name">{{ customer.salesLeader || '--' }}</span>
                  </div>
                  </div>
                </div>
                <div class="info-item">
                  ...
                  <div class="info-value">
                    <div class="user-info" v-if="customer.assistant">
                      <el-avatar :size="20" class="bg-green-600">
                        {{ customer.assistant && customer.assistant.charAt(0) }}
                      </el-avatar>
                      <span class="user-name">{{ customer.assistant }}</span>
                    </div>
                    <span v-else>--</span>
                  </div>
                </div>
                <div class="info-item">
                  ...
                  <div class="user-info">
                    <el-avatar :size="20" class="bg-purple-600">
                      ...
                      <span class="user-name">{{ customer.createBy || '--' }}</span>
                  </div>
                  </div>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                  ...
                  <div class="info-value">{{ customer.updateTime || '--' }}</div>
                </div>
                <div class="info-item">
                  <div class="info-label">更新人</div>
                  <div class="info-value">{{ customer.updateBy || '--' }}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <el-tab-pane label="联系人" name="contacts">
          <div class="tab-content">
            <div class="section-header">
              <el-button icon="el-icon-plus" type="primary" size="mini" @click="handleAddContact" v-hasPermi="['crm:contact:add']">
                添加联系人
              </el-button>
            </div>
          ...
          <template slot-scope="scope">
            ...
            <span v-else>--</span>
              ...
              <el-table-column label="操作" width="80" align="center">
                <template slot-scope="{ row }">
                  <el-button type="text" size="mini" icon="el-icon-edit" @click="handleEditContact(row)" v-hasPermi="['crm:contact:edit']">
                    编辑
                  </el-button>
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="跟进记录" name="followups">
          <div class="tab-content">
            <div class="section-header">
              <el-button icon="el-icon-plus" type="primary" size="mini" @click="handleAddFollowUp" v-hasPermi="['crm:followRecord:add']">
                添加跟进
              </el-button>
            </div>
            ...
            >
              <el-table-column prop="followContent" label="跟进内容" min-width="200" align="center">
                <template slot-scope="{ row }">
                  <div class="cursor-pointer" @click="handleViewFollowup(row)">
              ...
              <el-table-column prop="followMethod" label="跟进方式" width="100" align="center">
                <template slot-scope="{ row }">
                  <el-tag :type="getMethodColor(row.followMethod)" size="mini">
              ...
              <el-table-column label="操作" width="80" align="center">
                <template slot-scope="{ row }">
                  <el-button type="text" size="mini" icon="el-icon-edit" @click="handleEditFollowup(row)" v-hasPermi="['crm:followRecord:edit']">
                    编辑
                  </el-button>
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="跟进计划" name="plans">
          <div class="tab-content">
            <div class="section-header">
              <el-button icon="el-icon-plus" type="primary" size="mini" @click="handleAddPlan" v-hasPermi="['crm:followPlan:add']">
                制定计划
              </el-button>
            </div>
            ...
            >
              <el-table-column prop="planContent" label="计划内容" min-width="200" align="center" />
              <el-table-column prop="planExecutor" label="执行人" width="100" align="center" />
              <el-table-column prop="planTime" label="计划时间" width="150" align="center">
                <template slot-scope="{ row }">
                  {{ formatDate(row.planTime) }}
                </template>
              </el-table-column>
              <el-table-column prop="planState" label="状态" width="80" align="center">
                <template slot-scope="{ row }">
                  <el-tag :type="row.planState === 1 ? 'success' : 'warning'" size="mini">
              ...
              <el-table-column label="操作" width="80" align="center">
                <template slot-scope="{ row }">
                  <el-button type="text" size="mini" icon="el-icon-edit" @click="handleEditPlan(row)" v-hasPermi="['crm:followPlan:edit']">
                    编辑
                  </el-button>
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="项目跟进" name="projectFollow">
          <div class="tab-content">
            <div class="section-header">
              <el-button icon="el-icon-plus" type="primary" size="mini" @click="handleAddProjectFollow" v-hasPermi="['crm:projectFollow:add']">
                新增项目跟进
              </el-button>
            </div>
            ...
            >
              ...
              <el-table-column prop="projectNode" label="项目阶段" width="100" align="center">
                <template slot-scope="{ row }">
                  <el-tag :type="getProjectNodeType(row.projectNode)" size="mini">
                    {{ row.projectNode || '--' }}
                  </el-tag>
                </template>
              </el-table-column>
              <el-table-column prop="projectBackground" label="项目背景" min-width="150" align="center">
                <template slot-scope="{ row }">
                  <div class="text-ellipsis" :title="row.projectBackground">
                    {{ row.projectBackground || '--' }}
                  </div>
                </template>
              </el-table-column>
              <el-table-column prop="projectMilestones" label="项目里程碑" min-width="150" align="center">
                <template slot-scope="{ row }">
                  <div class="text-ellipsis" :title="row.projectMilestones">
              ...
              <el-table-column prop="projectTest" label="项目测试" min-width="120" align="center">
                <template slot-scope="{ row }">
                  <div class="text-ellipsis" :title="row.projectTest">
                    {{ row.projectTest || '--' }}
                  </div>
                </template>
              </el-table-column>
              <el-table-column prop="requirementLink" label="需求链接" width="100" align="center">
                <template slot-scope="{ row }">
                  <el-button 
              ...
              <el-table-column label="操作" width="80" align="center" fixed="right">
                <template slot-scope="{ row }">
                  <el-button type="text" size="mini" icon="el-icon-edit" @click="handleEditProjectFollow(row)" v-hasPermi="['crm:projectFollow:edit']">
                    编辑
                  </el-button>
                </template>
              </el-table-column>
...
export default {
  ...
  dicts: ['customer_type_enum', 'control_type', 'product_intention', 'settlement_period', 'tax_type', 'bank_account', 'follow_method', 'country_origin'],
  components: {
    QuickFollowUpModal,
    ContactFormModal,
    FollowPlanFormDialog,
  ...
  computed: {
    ...
    filteredQuickFollowupList() {
      ...
      return this.followUpList.filter(item => {
        const content = (item.followContent || item.content || '').toLowerCase()
        const user = (item.follower || item.user || '').toLowerCase()
        const method = (item.followMethod || item.method || '').toLowerCase()
        const methodText = this.getMethodText(item.followMethod || item.method).toLowerCase()
  ...
  methods: {
    ...
    async handleQuickFollowup() {
      ...
      try {
        ...
        const currentUserName = currentUser.nickName || currentUser.userName || '当前用户'
    ...
    getSettlementPeriodLabel(dictCode) {
      ...
      const dict = this.settlementPeriodDict.find(item => item.dictCode === dictCode)
    ...
    getDictLabel(dictType, value) {
      ...
      const list = (this.dict && this.dict.type && this.dict.type[dictType]) || []
      const match = list.find(item => String(item.value) === String(value) || String(item.dictCode || item.raw?.dictCode) === String(value))
    ...
    settlementPeriodItem(value) {
      ...
      return list.find(item => String(item.value) === String(value) || String(item.raw?.dictCode) === String(value)) || null
    },
