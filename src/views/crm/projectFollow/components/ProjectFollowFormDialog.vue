  ...
  >
    ...
    >
      ...
      <fieldset class="form-fieldset">
        ...
        <el-form-item label="需求总表链接" prop="requirementLink">
          <el-input
      ...
      <fieldset class="form-fieldset">
        ...
        <el-form-item label="产品关键特性" prop="productKeyFeatures">
          <el-input
            v-model="form.productKeyFeatures"
            type="textarea"
            :rows="3"
            placeholder="请输入产品关键特性"
            maxlength="1000"
            show-word-limit
          />
        </el-form-item>

        <el-form-item label="项目里程碑" prop="projectMilestones">
          <el-input
            v-model="form.projectMilestones"
            type="textarea"
            :rows="3"
            placeholder="请输入项目里程碑"
            maxlength="1000"
            show-word-limit
          />
        </el-form-item>
        ...
        <el-form-item label="项目测试" prop="projectTest">
          <el-input
            v-model="form.projectTest"
            type="textarea"
            :rows="3"
            placeholder="请输入项目测试相关信息"
            maxlength="1000"
            show-word-limit
          />
        </el-form-item>
