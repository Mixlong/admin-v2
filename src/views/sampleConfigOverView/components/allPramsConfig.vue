<template>
  ...
  <script>
  import { computerNameList } from "@/api/third/sampleFileConfig";
  import {
    sampleModelConfigList,
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        this.brandList = [];
        sampleModelConfigList(this.queryParams).then((res) => {
